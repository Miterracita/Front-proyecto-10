(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))r(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();const q=e=>`
    ...
    `;window.ConfirmarAsistencia=async e=>{await x(e)};window.EliminarEvento=async e=>{await I(e)};const C=()=>{const e=document.querySelector("body");e.className="",e.classList.add("body-newEvent");const t=document.querySelector("main"),n=`
    ...
    `;t.innerHTML=n;const r=async()=>{try{const c=await fetch(`${o}events/events`);if(!c.ok)throw new Error("Error al obtener los eventos");return await c.json()}catch(c){return console.error("Error al obtener los eventos:",c),[]}},o="https://back-proyecto-10-mu.vercel.app/",s=localStorage.getItem("token"),a=document.querySelector("#newEventForm"),i=async c=>{c.preventDefault();const[v,f,p,l,y,S]=c.target,d=new FormData;d.append("name",v.value),d.append("description",f.value),d.append("date",p.value),d.append("time",l.value),d.append("location",y.value),d.append("img",S.files[0]);try{const m=await fetch(`${o}events/nuevoEvento`,{method:"POST",headers:{Authorization:`Bearer ${s}`},body:d});if(!m.ok){console.error("Error en la respuesta del servidor:",m.statusText);return}const $=document.querySelector("#error-message"),k=await m.json();console.log("Respuesta del servidor:",k),$.textContent="El evento se ha creado correctamente.";const L=await r();setTimeout(()=>{EventList(L)},8e3)}catch(m){console.error("Error en la solicitud:",m)}};a.addEventListener("submit",i)},P=()=>{const e=document.querySelector("header");e.innerHTML=`
        <div class="header-btns">
            <button class="btn btn-header" id="new-event-link">Crear nuevo evento</button>
        </div>
    `,document.querySelector("#new-event-link").addEventListener("click",n=>{n.preventDefault(),C(),j(),A()})},T=()=>{const e=`
        <h2>Filtros</h2>
    ...
    `,t=document.querySelector(".filtros");t.innerHTML=e,document.querySelector("#filtro-eventos").addEventListener("submit",r=>{r.preventDefault();const o=document.querySelector("#event-name").value.trim();o?B(o):alert("Por favor, ingresa un nombre de evento para buscar.")})},E=e=>{const t=document.querySelector("body");t.className="",t.classList.add("body-eventList");const n=document.querySelector("main"),o=`
            <section id="eventos">
...
`)}
    ...
    `;t.innerHTML=n;const r=document.querySelector("#loginForm"),o=document.querySelector("#username"),s=document.querySelector("#password");r.addEventListener("submit",function(i){i.preventDefault(),w(o.value,s.value)}),document.querySelector("#register-link").addEventListener("click",i=>{i.preventDefault(),H()})},F=e=>{const t=document.querySelector("body");t.className="",t.classList.add("body-eventPage");const n=document.querySelector("main"),o=`
