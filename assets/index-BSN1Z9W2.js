(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&r(a)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();const k=e=>`
    ...
    `,q=()=>{const e=document.querySelector("body");e.className="",e.classList.add("body-newEvent");const t=document.querySelector("main"),s=`
    ...
    `;t.innerHTML=s;const r=async()=>{try{const i=await fetch(`${n}events/events`);if(!i.ok)throw new Error("Error al obtener los eventos");return await i.json()}catch(i){return console.error("Error al obtener los eventos:",i),[]}},n="https://back-proyecto-10-mu.vercel.app/",o=localStorage.getItem("token"),a=document.querySelector("#newEventForm"),c=async i=>{i.preventDefault();const[m,g,p,l,y,S]=i.target,d=new FormData;d.append("name",m.value),d.append("description",g.value),d.append("date",p.value),d.append("time",l.value),d.append("location",y.value),d.append("img",S.files[0]);try{const u=await fetch(`${n}events/nuevoEvento`,{method:"POST",headers:{Authorization:`Bearer ${o}`},body:d});if(!u.ok){console.error("Error en la respuesta del servidor:",u.statusText);return}const x=document.querySelector("#error-message"),$=await u.json();console.log("Respuesta del servidor:",$),x.textContent="El evento se ha creado correctamente.";const L=await r();setTimeout(()=>{f(L)},8e3)}catch(u){console.error("Error en la solicitud:",u)}};a.addEventListener("submit",c)},P=()=>{const e=document.querySelector("header");e.innerHTML=`
        <div class="header-btns">
            <button type="submit" class="btn btn-header" id="new-event-link">Crear nuevo evento</button>
        </div>
    `,document.querySelector("#new-event-link").addEventListener("click",s=>{s.preventDefault(),q(),w()})},N=()=>{const e=`
        <h2>Filtros</h2>
...
`)}
    ...
    `;t.innerHTML=s;const r=document.querySelector("#loginForm"),n=document.querySelector("#username"),o=document.querySelector("#password");r.addEventListener("submit",function(c){c.preventDefault(),h(n.value,o.value)}),document.querySelector("#register-link").addEventListener("click",c=>{c.preventDefault(),H()})},A=e=>{const t=document.querySelector("body");t.className="",t.classList.add("body-eventPage");const s=document.querySelector("main"),r=`
